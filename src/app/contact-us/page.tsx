...
const ContactUs = () => {
  return (
    <div className="bg-[#fffefa] w-full min-h-screen relative pt-[120px] sm:pt-[140px]">
      {/* SECTION 1: Discover Us */}
      <section className="max-w-[1728px] mx-auto px-4 sm:px-8 md:px-12 lg:px-[88px] py-12 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
          {/* LEFT SIDE */}
          <div className="flex flex-col justify-center gap-10">
            <div>
              <h2 className="font-[Playfair_Display] font-bold text-black text-3xl sm:text-4xl md:text-[40px] mb-5">
                DISCOVER US
              </h2>

              <p className="font-[Urbanist] text-[#18191f] text-base sm:text-lg md:text-[20px] leading-7 sm:leading-8 mb-6">
                Interior design is here to help you.
                <br />
                Our experts are available to answer any <br />
                questions you might have. We have got the answers.
            ...
            <div className="flex flex-col gap-6 sm:gap-8">
              {/* VISIT US */}
              <div>
                <h3 className="font-[Urbanist] font-bold text-[#18191f] text-lg sm:text-xl md:text-[20px] mb-2">
                  VISIT US
                </h3>
                <div className="flex items-start gap-3">
                  <span className="text-[#996830] text-xl">📍</span>
                  <p className="text-[16px] sm:text-[18px] text-[#18191f] leading-6 sm:leading-7">
                    B-61 1st Floor <br />
                    Ecosphere Co-working, <br />
                    Noida Sec-67 Pin - 201301
                  </p>
                </div>
              </div>
              ...
              {/* EMAIL US */}
              <div>
                <h3 className="font-bold text-[#18191f] text-lg sm:text-xl md:text-[20px] mb-2">
                  EMAIL US
                </h3>
                <div className="flex items-center gap-3">
                  <span className="text-[#996830] text-xl">✉️</span>
                  <p className="text-[16px] sm:text-[18px] text-[#18191f] leading-6 sm:leading-7 break-words">
                    hardik.arcol@gmail.com
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="w-full h-[180px] sm:h-[220px] md:h-[280px] rounded-2xl overflow-hidden shadow-md sm:shadow-lg">
                <Image
                  src="/Images/contact1.png"
                  alt="Interior 1"
                  className="w-full h-full object-cover"
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              {["/Images/contact3.png", "/Images/contact4.png", "/Images/contact5.png"].map(
                (img, i) => (
                  <div
                    key={i}
                    className="w-full h-[220px] sm:h-[280px] md:h-[350px] rounded-2xl overflow-hidden shadow-md sm:shadow-lg"
                  >
                    <Image
                      src={img}
                      alt={`Interior ${i + 3}`}
      ...
      {/* SECTION 3: GOOGLE MAP */}
      <section className="max-w-full mx-auto mt-24"> <div className="w-full h-[500px] overflow-hidden shadow-[0px_4px_20px_rgba(0,0,0,0.1)]"> <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3020.717824051368!2d-73.87199628459362!3d40.71353797933083!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25eb3d3f8473b%3A0x4f7f07b704a8df7b!2sForest%20Hills%2C%20Queens%2C%20NY!5e0!3m2!1sen!2sus!4v1696361591234!5m2!1sen!2sus" width="100%" height="100%" style={{ border: 0 }} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade" ></iframe> </div> </section>
